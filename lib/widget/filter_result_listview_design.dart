...
class FilterResultListViewDesign extends StatelessWidget {
  const FilterResultListViewDesign();
  ...
  List<String> getMaxMinAge(String ageRange) {
    if (ageRange == 'other') return ['15.0', '100.0'];
  ...
  Widget build(BuildContext context) {
    ...
    return (foundChildGender == null ||
                foundChildGender.toString().toLowerCase() ==
            ...
            post.ownerId != Users.currentUser.documentID
        ? Padding(
